...
function nextEvent() {
    ...
    var eventElement = displayEvent(EVENTS[eventIndex++%EVENTS.length]);
...
/* calcul de la luminance d'une couleur ; source : https://stackoverflow.com/questions/1754211/evaluate-whether-a-hex-value-is-dark-or-light */
